...
/***********************************/
/* FROM: jquery.scrollupformenu.js */
 ...
 */
	...
	function Plugin ( element, options, nav ) {
	...
	Plugin.prototype = {
		...
		refresh: function (settings) { 
			...
			if (scrollTop > lastScrollTop && scrollTop > $header.height()){ // ensure that the header doesnt disappear too early
				// downscroll
				if (!this.nav.isOpen()) {
	...
	$.fn[ pluginName ] = function ( nav, options ) {
		return this.each(function() {
				if ( !$.data( this, "plugin_" + pluginName ) ) {
						$.data( this, "plugin_" + pluginName, new Plugin( this, options, nav ) );
				}
		});
	};
